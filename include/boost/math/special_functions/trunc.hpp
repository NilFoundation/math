...
inline BOOST_GPU_ENABLED typename tools::promote_args<T>::type trunc(const T& v, const Policy& pol, const boost::false_type&)
{
...
template <class T, class Policy>
inline BOOST_GPU_ENABLED typename tools::promote_args<T>::type trunc(const T& v, const Policy&, const boost::true_type&)
{
   return v;
}
