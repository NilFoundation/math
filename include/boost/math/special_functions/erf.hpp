...
inline BOOST_GPU_ENABLED float erf_asymptotic_limit_N(const boost::integral_constant<int, 24>&)
{
   return 2.8F;
}
inline BOOST_GPU_ENABLED float erf_asymptotic_limit_N(const boost::integral_constant<int, 53>&)
{
   return 4.3F;
}
inline BOOST_GPU_ENABLED float erf_asymptotic_limit_N(const boost::integral_constant<int, 64>&)
{
   return 4.8F;
}
inline BOOST_GPU_ENABLED float erf_asymptotic_limit_N(const boost::integral_constant<int, 106>&)
{
   return 6.5F;
}
inline BOOST_GPU_ENABLED float erf_asymptotic_limit_N(const boost::integral_constant<int, 113>&)
{
   return 6.8F;
}
...
template <class T, class Policy>
BOOST_GPU_ENABLED T erf_imp(T z, bool invert, const Policy& pol, const boost::integral_constant<int, 53>& t)
{
   BOOST_MATH_STD_USING
...
template <class T, class Policy>
BOOST_GPU_ENABLED T erf_imp(T z, bool invert, const Policy& pol, const boost::integral_constant<int, 64>& t)
{
   BOOST_MATH_STD_USING
...
template <class T, class Policy>
BOOST_GPU_ENABLED T erf_imp(T z, bool invert, const Policy& pol, const boost::integral_constant<int, 113>& t)
{
   BOOST_MATH_STD_USING
