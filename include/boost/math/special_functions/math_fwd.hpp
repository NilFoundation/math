...
namespace boost
{
   ...
   BOOST_GPU_ENABLED BOOST_CXX14_CONSTEXPR typename tools::promote_args<T>::type pow(T base, const Policy& policy);

   template <int N, typename T>
   BOOST_GPU_ENABLED BOOST_CXX14_CONSTEXPR typename tools::promote_args<T>::type pow(T base);
