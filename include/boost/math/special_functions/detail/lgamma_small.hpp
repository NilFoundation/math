...
//
template <class T, class Policy, class Lanczos>
BOOST_GPU_ENABLED T lgamma_small_imp(T z, T zm1, T zm2, const boost::integral_constant<int, 64>&, const Policy& /* l */, const Lanczos&)
{
...
template <class T, class Policy, class Lanczos>
BOOST_GPU_ENABLED T lgamma_small_imp(T z, T zm1, T zm2, const boost::integral_constant<int, 113>&, const Policy& /* l */, const Lanczos&)
{
   //
   // This version uses rational approximations for small
...
template <class T, class Policy, class Lanczos>
BOOST_GPU_ENABLED T lgamma_small_imp(T z, T zm1, T zm2, const boost::integral_constant<int, 0>&, const Policy& pol, const Lanczos&)
{
   //
