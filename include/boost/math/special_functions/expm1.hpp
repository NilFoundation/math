...
BOOST_GPU_ENABLED T expm1_imp(T x, const boost::integral_constant<int, 0>&, const Policy& pol)
{
...
BOOST_GPU_ENABLED T expm1_imp(T x, const boost::integral_constant<int, 53>&, const P& pol)
{
   BOOST_MATH_STD_USING
...
template <class T, class P>
BOOST_GPU_ENABLED T expm1_imp(T x, const boost::integral_constant<int, 64>&, const P& pol)
{
   BOOST_MATH_STD_USING
...
template <class T, class P>
BOOST_GPU_ENABLED T expm1_imp(T x, const boost::integral_constant<int, 113>&, const P& pol)
{
   BOOST_MATH_STD_USING
