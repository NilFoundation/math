...
inline BOOST_MATH_CONSTEXPR BOOST_GPU_ENABLED int digits_imp(boost::true_type const&) BOOST_NOEXCEPT
{
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR BOOST_GPU_ENABLED int digits_imp(boost::false_type const&) BOOST_NOEXCEPT
{
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR BOOST_GPU_ENABLED T get_epsilon_imp(boost::true_type const&) BOOST_MATH_NOEXCEPT(T)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR BOOST_GPU_ENABLED T get_epsilon_imp(boost::false_type const&) BOOST_MATH_NOEXCEPT(T)
{
